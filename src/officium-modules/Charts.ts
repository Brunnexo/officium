...
class Charts {
    ...
    render(data: Labor) {
        ...
        // Gráfico de tempo apontado por projeto
...
//     updateInfo(i: Information) {
//         Object.keys(i).forEach((key) => {
//             this.info[key] = i[key];
//         });
//     }

//     async getData(page: 'resume' | 'labor', date: string) {
//         let _info = this.info;

//         let element = document.getElementById(_info.component[component]),
//             infoDate = new Date(date);

//         let isWeekend = ((infoDate.getDay() == 6) ||  (infoDate.getDay() == 0));
